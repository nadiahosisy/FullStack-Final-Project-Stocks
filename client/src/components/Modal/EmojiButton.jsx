    ...
    <a className="button">
      <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 64 64">
        ...
        <g className="tongue">
          <path
            fill="#74e063"
            d="m32 40h-10c0 0 0 2.787 0 5.92 0 10.703 4.478 16.08 9.998 16.08 5.523 0 10-5.377 10-16.08 0-3.131 0-5.918 0-5.918h-10"
          />
          <path
            opacity=".33"
            d="m39.642 40v5.66c-.001 8.348-3 13.74-7.643 13.74-4.642-.003-7.64-5.396-7.64-13.738v-5.662h-.805v5.662c0 8.878 3.314 14.617 8.443 14.621h.001c5.13 0 8.446-5.74 8.448-14.623v-5.66h-.804"
          />
